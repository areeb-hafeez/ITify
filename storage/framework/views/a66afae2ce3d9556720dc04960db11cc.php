 <!--Full width header Start-->
            <div class="full-width-header">
                               ...
                               <div class="col-lg-8">
                                   <ul class="topbar-contact">
                                        ...
                                        <li>
                                           ...
                                           <a href="tel:+92(302)4951–601"> +92 (302) 4951–601</a>
                                        </li>
                                        <li>
                    ...
                    <div class="menu-area menu-sticky">
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-lg-2">
                                    <div class="logo-part">
                                        <a href="#"><img style="max-height: -webkit-fill-available;" src="<?php echo e(asset('assets/images/ITFY%20logo-01.png')); ?>" alt=""></a>
                                    </div>
                ...
                <nav class="right_menu_togle hidden-md">
                    ...
                    <div class="canvas-logo">
                        <a href="index-2.html"><img src="<?php echo e(asset('assets/images/logo-dark.png')); ?>" alt="logo"></a>
                    </div>
            ...
            <!--Full width header End--><?php /**PATH H:\Xampp files\htdocs\ITify\resources\views/includes/header.blade.php ENDPATH**/ ?>