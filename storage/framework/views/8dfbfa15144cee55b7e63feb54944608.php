<!-- meta tag -->
        <meta charset="utf-8">
        <title>ITify SMC Private Limited</title>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('assets/images/ITFY%20logo-01.png')); ?>">
        ...
        <!-- off canvas css -->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/off-canvas.css')); ?>">
        <!-- magnific popup css -->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/magnific-popup.css')); ?>">
        <!-- Main Menu css -->
        <link rel="stylesheet" href="<?php echo e(asset('assets/css/rsmenu-main.css')); ?>">
        <!-- spacing css -->
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/rs-spacing.css')); ?>">
        <!-- style css -->
        ...
        <![endif]--><?php /**PATH H:\Xampp files\htdocs\ITify\resources\views/includes/head.blade.php ENDPATH**/ ?>