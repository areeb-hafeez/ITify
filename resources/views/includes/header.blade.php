            ...
            <div class="full-width-header">
                    ...
                    <div class="menu-area menu-sticky">
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-lg-2">
                                    <div class="logo-part">
                                        <a href="#"><img style="max-height: -webkit-fill-available;" src="{{asset('assets/images/ITFY%20logo-01.png')}}" alt=""></a>
                                    </div>
                ...
                <nav class="right_menu_togle hidden-md">
                    ...
                    <div class="canvas-logo">
                        <a href="index-2.html"><img src="{{asset('assets/images/logo-dark.png')}}" alt="logo"></a>
                    </div>
